...
public class UMLModelASTReader {
	...
	private void processTypeDeclaration(TypeDeclaration typeDeclaration, String packageName, String sourceFile,
		...
		UMLClass umlClass = new UMLClass(packageName, className, sourceFile,
				typeDeclaration.isPackageMemberTypeDeclaration(), importedTypes);
		...
		for (MethodDeclaration methodDeclaration : methodDeclarations) {
			UMLOperation operation = processMethodDeclaration(methodDeclaration, packageName, className,
					umlClass/* , bytecodeClass */);
		...
		while (enumeration.hasMoreElements()) {
			...
			if (node.getUserObject() != null) {
				...
				UMLAnonymousClass anonymousClass = processAnonymousClassDeclaration(anonymous,
						packageName + "." + className, anonymousName, sourceFile);
	...
	private UMLOperation processMethodDeclaration(MethodDeclaration methodDeclaration, String packageName,
			String className, UMLClass theClass) {
		...
		if (theClass != null)
			umlOperation.setContainerClass(theClass);
	...
	private UMLAnonymousClass processAnonymousClassDeclaration(AnonymousClassDeclaration anonymous, String packageName,
